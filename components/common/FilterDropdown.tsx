...
export default function Dropdown({values, value, onChange, error}: any) {
  ...
  return (
      <Listbox value={selected} onChange={handleChange}>
        <div className={`relative w-12/12 sm:w-2/3 h-full z-40`} onClick={() => rotateArrow()}>
          <Listbox.Button className={"appearance-none flex items-center justify-end block w-full h-full pr-10 2xl:px-6 relative py-2 rounded-md placeholder-white focus:outline-none text-base 2xl:text-2xl"}>
