  ...
  return (
      <Listbox value={selected} onChange={handleChange}>
        <DropdownContainer id="button">
          <Listbox.Button className={"appearance-none border-2 border-[#DEDEDE] flex items-center block w-full h-8 mt-1 pr-10 pl-2 2xl:px-6 relative py-2 bg-[#F2F2F2] rounded-xl placeholder-white focus:outline-none text-md 2xl:text-2xl"}>
